...
static inline int is_lsx_enabled(void)
{
	...
	return (csr_read64(LOONGARCH_CSR_EUEN) & CSR_EUEN_LSXEN) ?
		1 : 0;
}
...
static inline int is_lasx_enabled(void)
{
	...
	return (csr_read64(LOONGARCH_CSR_EUEN) & CSR_EUEN_LASXEN) ?
		1 : 0;
}
...
{
	if (cpu_has_lsx)
		csr_xchg64(CSR_EUEN_LSXEN, CSR_EUEN_LSXEN, LOONGARCH_CSR_EUEN);
}

static inline void disable_lsx(void)
{
	if (cpu_has_lsx)
		csr_xchg64(0, CSR_EUEN_LSXEN, LOONGARCH_CSR_EUEN);
}
...
static inline void enable_lasx(void)
{
	...
	if (cpu_has_lasx)
		csr_xchg64(CSR_EUEN_LASXEN, CSR_EUEN_LASXEN, LOONGARCH_CSR_EUEN);
}

static inline void disable_lasx(void)
{
	if (cpu_has_lasx)
		csr_xchg64(0, CSR_EUEN_LASXEN, LOONGARCH_CSR_EUEN);
}
